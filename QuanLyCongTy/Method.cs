...
namespace QuanLyCongTy
{
    internal class Method
    {
        ...
        private void Menu3()
        {
            ...
            {
                Console.WriteLine("\nManger thu " + i + " la: ");
                _managers[i].ThongTin.XemThongTin();
        ...
        private void Menu4()
        {
            ...
            foreach (Employer item in _employers)
            {
                if (ma == item.Ma)
                {
                    item.XemThongTin();
            ...
            foreach (Manager item in _managers)
            {
                if (ma == item.ThongTin.Ma)
                {
                    item.ThongTin.XemThongTin();
                    count++;
                }
            }
            if (count == 0)
        ...
        private void ChonManager(Employer employer)
        {
            ...
            Console.WriteLine("\nDa cho Manager: " + _managers[a].ThongTin.Ten + " quan ly: " + employer.Ten);
        }
